...
{
    public partial class adingAllTablesAroundTheProductsAndGreeDityAndForum : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GreekDeities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SculptureMaterials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GreekDeityId = table.Column<int>(type: "int", nullable: false),
                    IsGardenStatue = table.Column<bool>(type: "bit", nullable: true),
                    Color = table.Column<int>(type: "int", nullable: false),
                    SculptureType = table.Column<int>(type: "int", nullable: false),
                    AddedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Origin = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.GreekDeityId,
                        principalTable: "GreekDeities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sculptures_SculptureMaterials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "SculptureMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sculptures_AddedByUserId",
                table: "Sculptures",
                column: "AddedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sculptures_IsDeleted",
                table: "Sculptures",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Sculptures_MaterialId",
                table: "Sculptures",
                column: "MaterialId");
        }
